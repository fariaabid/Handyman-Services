...
import serviceImg from '../../../images/pending.png';
...
const ServiceList = () => {
    ...
    useEffect(() => {
        fetch('https://ancient-cove-35788.herokuapp.com/order?email=' + loggedInUser.email)
            .then(res => res.json())
            .then(data => {
            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-3 col-sm-12 col-12 py-3">
                        <Link to="/home" >
                            <img  style={{width:'50px',height:'50px'}} src={logo} alt="" className="logo" />
                        </Link>
                    </div>
